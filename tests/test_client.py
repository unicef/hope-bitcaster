...
from hope_bitcaster.client import HopeBitcasterClient, get_hope_bitcaster_client
...
def test_get_client_returns_instance(bitcaster_settings):
    with patch("hope_bitcaster.client.import_string") as mock_import:
...
def test_trigger_event_calls_sdk():
    ...
    client.trigger_event("some_event", {"pk": 1})

    mock_sdk.trigger_event.assert_called_once_with("some_event", context={"pk": 1})
